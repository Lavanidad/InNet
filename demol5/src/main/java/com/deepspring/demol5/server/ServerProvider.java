...
import com.deepspring.demol5.constans.UDPConstans;
...
public class ServerProvider {
    ...
    private static class Provider extends Thread {
        ...
        public void run() {
            ...
            try {
                // 监听20000端口
                ds = new DatagramSocket(UDPConstans.PORT_SERVER);
                // 接收消息packet
                ...
                while (!done) {
                    ...
                    boolean isValid = clientDataLength >= (UDPConstans.HEADER.length + 2 + 4) &&
                           ByteUtils.startsWith(clientData, UDPConstans.HEADER);
                    ...
                    //解析命令与发送回送端口
                    int index = UDPConstans.HEADER.length;
                    ...
                    if (cmd == 1 && responsePort > 0) {
                        ...
                        byteBuffer.put(UDPConstans.HEADER);
